...
function SectionFour(){
    ...
    return <>
    <section id="contact" className="section-four-main-container">
      <section className="contact-text">
        <span className="me-2">Bog'lanish</span>
      ...
      <section className="section-four-container">
        ...
        <a className="sec-four-box" href="tel:+998882140099">
            <div>
        ...
        <a className="sec-four-box" href="https://t.me/brooklynadminbot">
            <div>
